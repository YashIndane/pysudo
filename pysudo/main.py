...
def solve(problem) -> list : 
    ...
    def generate_bounds(r , c) -> list : # Generates the semi-grid where checking is to be done
    ...
    np_problem = np_problem.tolist()
    full_numbers = []

    for x_ in np_problem :
